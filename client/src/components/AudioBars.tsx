...
export const AUDIO_BAR_COLORS: Record<'classic' | 'race' | 'year' | 'party', string> = {
...
export const ACCENT_TINT_CLASS: Record<'classic' | 'race' | 'year' | 'party', string> = {
...
export const ACCENT_WASH: Record<'classic' | 'race' | 'year' | 'party', string> = {
...
export function AudioBars({ playing, accent, height, bpm }: Readonly<{ playing: boolean; accent: 'classic' | 'race' | 'year' | 'party'; height: number; bpm?: number | null }>) {
